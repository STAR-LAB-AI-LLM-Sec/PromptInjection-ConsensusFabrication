#!/usr/bin/env bash
# =============================================================================
# 攻击方终端脚本 —— ChatOps 团队协作助手攻防基准（Baseline：多源共识伪造）
#
...
#     bash run_attack.sh
#
# 输出：ConsensusForgeryAttack 面对 NoDefense 与防御 Baseline 的攻击胜率、
#       注入有效率、平均工具调用数
# =============================================================================
set -euo pipefail
cd "$(dirname "$0")"
...
echo ">>> [run_attack] 攻击方 Baseline 评测（ConsensusForgeryAttack）"
